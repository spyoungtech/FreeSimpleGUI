...
class Tree(Element):
    """
    Tree Element - Presents data in a tree-like manner,
    much like a file/folder browser.
    Uses the `TreeData` class to hold the user's data
    and pass to the element for display.
    """
